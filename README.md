...
> [!IMPORTANT]
> Zeebe Process Test is **deprecated** since Camunda 8.8 and **unsupported** since Camunda 8.10.
> Camunda's new testing library is [Camunda Process Test](https://docs.camunda.io/docs/apis-tools/testing/getting-started/).
> See the [migration guide](https://docs.camunda.io/docs/8.9/apis-tools/migration-manuals/migrate-to-camunda-process-test/) on how to migrate your existing process tests.
